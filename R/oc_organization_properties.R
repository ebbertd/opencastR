...
#' oc_organization_properties()
oc_organization_properties <- function() {
  # Set the url path
...
#' Print result of oc_organization_properties()
#'
#' Print a structured return of the oc_organization_properties() function.
#'
#' @param x The return of the function this print function relates to.
#' @param ... Possible further options to the print function.
#' @return A structured print of the return by the oc_organization_properties() function.
#' @seealso \code{\link{oc_organization_properties}}
...
#'
#' # Get the API key characteristics
#' resp <- oc_organization_properties()
#'
#' # Print out the key characteristics
#' resp
print.oc_organization_properties <- function(x, ...) {
  cat("<Opencast ", x$path, ">\n", sep = "")
  str(x$content)
  invisible(x)
}
