...
#'
#' @return A list containing the default api version.
...
#' @return A structured print of the return by the oc_version_default() function.
#' @seealso \code{\link{oc_version_default}}
...
#'
#' # resp
print.oc_version_default <- function(x, ...) {
  cat("<Opencast ", x$path, ">\n", sep = "")
  str(x$content)
  invisible(x)
}
